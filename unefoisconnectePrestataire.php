    ...
    <div class="containerprincipal">
        <div class="container">
            ...
            <a href="index.php" class="logo"><img src="img/logo.png" alt="" style="width:90px; margin-bottom:-4px;"></a>                <div class="onglets">
                    <div class="lien" id="lien1" style="justify-content: flex-start; width: 200px; "><img
                            src="icones/Vector.png" alt="" style="margin-left: 10px;"><a href="#projets" style="margin-left: 15px;">Mes projets</a></div>
                    <div class="lien" style="justify-content: flex-start; width: 200px;"> <img
                            src="icones/heroicons-solid_chat.png" alt="" style="margin-left: 4px;"><a
                            href="#forum"  style="margin-left: 10px;">Forum</a></div>
                    <div class="lien " style="justify-content: flex-start; width: 200px;"><img
                            src="icones/Vector-1.png" alt="" style="margin-left: 8px;"><a href="#Annonces"  style="margin-left: 10px;">Annonces </a></div>
                    <div class="lien" style="justify-content: flex-start; width: 200px;"><img
                            src="icones/chatbot.png" alt="" style="margin-left: 8px;"><a href="#ChatBot"  style="margin-left: 10px;">ChatBot</a></div>
                    <div class="lien" style="justify-content:flex-start; width: 200px;"><img
                            src="icones/f7_exclamationmark-square-fill.png" alt="" style="margin-left: 6px;"  > <a href="#Plaintes" style="margin-left: 10px;">Plaintes</a>
                    </div>
                </div>
            </div>
            <div class="contenu">
                <div class="entete">
                    <input type="search"
                        style="width: 230px; height:40px ; margin-right: 800px; 
                    font-family: Arial, Helvetica, sans-serif; font-size: 16px ; border-radius: 40px; padding-left: 20px;"
                ...
                <section id="forum" style="display: none;">
                    <div class="contenu">
                        ...
                        <div class="Ravi">
                            <p class="heureux" id="forumm">Forum</p>
                            <p id="avertissement">Vous pouvez discutez ici avec d'autres prestataires ou des
                                administrateurs
                            </p>
                        </div>
                        <div class="espacemessage">
                            <div class="concerner">
                                <p class="concerne">Prestataire et Administrateurs</p>
                                <p id="nombre">635 Membres
                                </p>
                            </div>
                            <div class="partie">
                                <div class="spartie">
                ...
                <section id="Annonces" style="display: none;">
                    <div class="contenu">
                        ...
                        <div class="Ravi">
                            ...
                            <p id="avertissement">Vous trouverez ici toutes les annonces publiés par les clients </p>
                        </div>
                        <div class="annonce">
                            <div class="elemntliste">
                                <p class="teliste">Garde d'enfants</p>
                ...
                <section id="ChatBot" style="display: none;">
                    <div class="contenu">
                        ...
                        <div class="Ravi">
                            ...
                            <p id="avertissement">Trouver des réponses à des questions fréquentes grâce à notre Chatbot
                            </p>
                        </div>
                        <div class="espacemessage">
                            <div class="concerner">
